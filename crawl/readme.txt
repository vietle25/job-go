...
Cài đặt môi trường đọc file crawler.py
https://docs.anaconda.com/anaconda/install/ 
https://docs.anaconda.com/anaconda/install/windows/ - Cài đặt cho window
Anaconda hỗ trợ sẵn các thư viện để thực hiện crawl dữ liệu (Xóa 3 file links.txt, data.csv, data.json trước khi pull)
Cách 1: Sử dụng Window -> Tìm kiếm Jupyter notebook -> Mở file cần crawler.py và execute
