...
class JobPostListView extends BaseView {
    constructor(props) {
        super(props);
        this.itemAll = {
            id: null,
    ...
    componentWillReceiveProps = nextProps => {
        if (nextProps != this.props) {
            if (nextProps.stringSearch != this.state.stringSearch) {
                this.filter.searchString = nextProps.stringSearch;
    ...
    handleData() {
        ...
        if (this.props.errorCode != ErrorCode.ERROR_INIT) {
            if (this.props.errorCode == ErrorCode.ERROR_SUCCESS) {
                if (this.props.action == getActionSuccess(ActionEvent.GET_MY_JOB_POST)) {
                    console.log("DATA GET GET_MY_JOB_POST LIST JOB VIEW: ", data)
                    if (data != null) {
     ...
     */
    getJobs = () => {
        console.log("GET getMyJobPost FILTER: ", this.filter);
        this.props.getMyJobPost(this.filter)
    }
