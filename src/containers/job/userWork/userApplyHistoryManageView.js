...
import ApplyHistoryList from './userApplyHistoryListView';

const HEADER_HEIGHT = Platform.OS === "ios" ? 64 : 56;
const screen = Dimensions.get('window')
const resetAction = CommonActions.goBack(null);

class UserApplyHistoryManageView extends BaseView {
...
export default connect(mapStateToProps, mapDispatchToProps)(UserApplyHistoryManageView)